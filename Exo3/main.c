...
int main() {
    ...
    //forctionne mais n'affiche pas les smileys
    //for (ligne = 0; ligne < 32; ligne++) {
     //   for (colonne = 0; colonne < 8; colonne++) {
     //       int caractere = ligne + (colonne * 32);
     //       if (isprint(caractere) != 0) {
     //           printf("%d %.2X %c   ", caractere, caractere, caractere); 
     //      }
     //      else {
     //          printf("%d %.2X    ", caractere, caractere);
     //       }
    ...
    for (i = 0; i < 32; i++) {
        for (j = 0; j < 8; j++) {
            ...
            printf(" %3d %.2X %c ", caractere, caractere, caractere);
